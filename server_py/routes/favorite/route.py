...
@favorite.route("/recipes/MyFavorites/ids/<_user_id>")
@validate_cookie
...
@favorite.route('/recipes/MyFavorites/<_user_id>')
@validate_cookie
...
@favorite.route('/recipes/MyFavorites/<user_id>/<recipe_id>', methods=["DELETE"])
@validate_cookie
...
@favorite.route('/recipes/MyFavorites/<user_id>/<recipe_id>', methods=["PUT"])
@validate_cookie
...
@favorite.route("/recipes/MyFavorites/ids/<user_id>/<recipe_id>", methods=["DELETE"])
@validate_cookie
